...
ENV PUPPETEER_SKIP_CHROMIUM_DOWNLOAD=true \
    ...
    PUPPETEER_ADDITIONAL_ARGS="--allow-running-insecure-content --disable-web-security --no-sandbox --unsafely-treat-insecure-origin-as-secure=http://admin.mint05.com" 
